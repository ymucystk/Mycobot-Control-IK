...
export default function Home(props) {
  ...
  const joint_pos = {
    ...
    j3:{x:0,y:0.11,z:0},
    j4:{x:0,y:0.096,z:0},
    j5:{x:0.06312,y:0.0748,z:0},
    j6:{x:0,y:0,z:0},
    j7:{x:0,y:0,z:0.06},
  }

  const [target,set_target] = React.useState({x:0.15,y:0.2,z:0.15})
...
const Assets = ()=>{
  return (
    <a-assets>
      ...
      <a-asset-items id="j1" src="Mycobot_j0.gltf" ></a-asset-items>
      <a-asset-items id="j2" src="Mycobot_j1.gltf" ></a-asset-items>
      <a-asset-items id="j3" src="Mycobot_j2.gltf" ></a-asset-items>
      <a-asset-items id="j4" src="Mycobot_j3.gltf" ></a-asset-items>
      <a-asset-items id="j5" src="Mycobot_j4.gltf" ></a-asset-items>
      <a-asset-items id="j6" src="Mycobot_j5.gltf" ></a-asset-items>
    </a-assets>
  )
}
